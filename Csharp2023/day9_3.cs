...
namespace Csharp2023
{
	internal class day9_3
	{
		static void Main()
		{
			...
			//ht1[1] = "Test";
			//ht1[2] = 1000;
			//Console.WriteLine(ht1[0]);
			//Console.WriteLine(ht1[1]);
			//Console.WriteLine(ht1[2]);
			//Console.WriteLine("===============\n");
			...
			//	["luck"] = 777
			//};
			//Console.WriteLine(myhashtable1["haha"]);
			//Console.WriteLine(myhashtable1["hoho"]);
			//Console.WriteLine(myhashtable1["luck"]);
			//Console.WriteLine("===============\n");
			...
			string myword2 = "banana fruit orange apple mango";
			string[] myword_arr2 = myword2.Split();
			Hashtable mytb = new Hashtable();

			//배열의 첫문자 출력
			char change;
            Console.Write("string myWord = \"");

            for (int i = 0; i < myword_arr2.Length; i++)
			{
				string word = myword_arr2[i];
				change = word[0];
				mytb[change] = word;
				if (i == myword_arr2.Length-1) Console.Write($"{mytb[change]}");
				else
				{
					//문자열 Split 확인용 
					//Console.WriteLine($"{myword_arr2[i]}");

					Console.Write($"{mytb[change]} ");
				}
            }
			Console.Write("\"");
			...
			//Hashtable myWordHash = new Hashtable();
			//string[] myWordArr = myWord.Split();

			//foreach (var item in myWordArr)
			//{
			//	Console.Write($"!!!!{item}");
			//}
			//Console.WriteLine();
			...
			//{
			//	key = word[0];
			//	Console.WriteLine(myWordHash[key]);
			//}
